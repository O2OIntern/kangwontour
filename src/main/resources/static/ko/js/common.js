...
function service(id) {
    ...
    switch (id) {
        ...
        case 'category2':
            ...
            break;
        case 'category3':
            that.canvas.sendTextQuery('추천코스2');
...
function option(id) {
    ...
    switch (id) {
        case 'during1':
            that.canvas.sendTextQuery('당일치기');
            break;
        case 'during2':
            that.canvas.sendTextQuery('1박 2일 동안');
            break;
        case 'during3':
            that.canvas.sendTextQuery('2박 3일 동안');
            break;
        case 'during4':
            that.canvas.sendTextQuery('3박 4일 동안');
            break;
        case 'age1':
            that.canvas.sendTextQuery('20대');
            break;
        case 'age2':
            that.canvas.sendTextQuery('30대');
            break;
        case 'age3':
            that.canvas.sendTextQuery('40대');
            break;
        case 'age4':
            that.canvas.sendTextQuery('50대');
            break;
        case 'together1':
            that.canvas.sendTextQuery('연인이서');
            break;
        case 'together2':
            that.canvas.sendTextQuery('친구끼리');
            break;
        case 'together3':
            that.canvas.sendTextQuery('가족들과');
            break;
        case 'together4':
            that.canvas.sendTextQuery('혼자서');
            break;
        case 'traffic1':
            that.canvas.sendTextQuery('자차로');
            break;
        case 'traffic2':
            that.canvas.sendTextQuery('자전거로');
            break;
        case 'traffic3':
            that.canvas.sendTextQuery('도보로');
            break;
    }
}
...
function sendText(keyword) { console.log("click sendText")
    this.canvas = window.interactiveCanvas;
    this.scene = scene;
    const that = this;
    console.log(keyword);
...
function typeAppend(word) {
    if (word.cat3 === "A03020500") word.type = "자전거하이킹";
    else if (word.cat3 === "A03021700") word.type = "야영장, 오토캠핑장";
    else if (word.cat3 === "A03030500") word.type = "민물낚시";
    else if (word.cat3 === "A03030600") word.type = "바다낚시";
    else if (word.cat3 === "A03050100") word.type = "복합 레포츠";
    else if (word.cat3 === "A02020800") word.type = "유람선/잠수함관광";
    else if (word.cat3 === "A03030100") word.type = "윈드서핑/제트스키";
    else if (word.cat3 === "A03030200") word.type = "카약/카누";
    else if (word.cat3 === "A03030700") word.type = "수영";
    else if (word.cat3 === "A03030800") word.type = "래프팅";
    else if (word.cat3 === "A03021200") word.type = "스키/스노보드";
    else if (word.cat3 === "A03021300") word.type = "스케이트";
    else if (word.cat3 === "A03021400") word.type = "썰매장";
    else if (word.cat3 === "A01010100") word.type = "국립공원";
    else if (word.cat3 === "A01010200") word.type = "도립공원";
    else if (word.cat3 === "A01010300") word.type = "군립공원";
    else if (word.cat3 === "A01010400") word.type = "산";
    else if (word.cat3 === "A01010500") word.type = "자연생태관광지";
    else if (word.cat3 === "A01010600") word.type = "자연휴양림";
    else if (word.cat3 === "A01010700") word.type = "수목원";
    else if (word.cat3 === "A01010800") word.type = "폭포";
    else if (word.cat3 === "A01010900") word.type = "계곡";
    else if (word.cat3 === "A01011000") word.type = "약수터";
    else if (word.cat3 === "A01011100") word.type = "해안절경";
    else if (word.cat3 === "A01011200") word.type = "해수욕장";
    else if (word.cat3 === "A01011300") word.type = "섬";
    else if (word.cat3 === "A01011400") word.type = "항구/포구";
    else if (word.cat3 === "A01011500") word.type = "어촌";
    else if (word.cat3 === "A01011600") word.type = "등대";
    else if (word.cat3 === "A01011700") word.type = "호수";
    else if (word.cat3 === "A01011800") word.type = "강";
    else if (word.cat3 === "A01011900") word.type = "동굴";
    else if (word.cat3 === "A02030100") word.type = "농.산.어촌 체험";
    else if (word.cat3 === "A02030500") word.type = "관광농원";
    else if (word.cat3 === "A02030400") word.type = "이색체험";
    else if (word.cat3 === "A02030600") word.type = "이색거리";
    else if (word.cat3 === "A02020100") word.type = "유원지";
    else if (word.cat3 === "A02020200") word.type = "관광단지";
    else if (word.cat3 === "A02020300") word.type = "온천/욕장/스파";
    else if (word.cat3 === "A02020400") word.type = "이색찜질방";
    else if (word.cat3 === "A02020500") word.type = "헬스투어";
    else if (word.cat3 === "A02020600") word.type = "테마공원";
    else if (word.cat3 === "A02020700") word.type = "공원";
    else if (word.cat3 === "A02030200") word.type = "전통체험";
    else if (word.cat3 === "A02030300") word.type = "산사체험";
    else if (word.cat3 === "A02010600") word.type = "민속마을";
    else if (word.cat3 === "A02010700") word.type = "유적지/사적지";
    else if (word.cat3 === "A02060100") word.type = "박물관";
    else if (word.cat3 === "A02060200") word.type = "기념관";
    else if (word.cat3 === "A02060300") word.type = "전시관";
    else if (word.cat3 === "A04010100") word.type = "5일장";
    else if (word.cat3 === "A04010200") word.type = "상설시장";
    else if (word.cat3 === "A04010700") word.type = "공예, 공방";
    else if (word.cat3 === "A04010800") word.type = "관광기념품점";
    else if (word.cat3 === "A04010900") word.type = "특산물판매점";
    else if (["B02010100", "B02010200", "B02010300", "B02010400"].indexOf(word.cat3) >= 0) word.type = "호텔";
    else if (["B02010500", "B02010600"].indexOf(word.cat3) >= 0) word.type = "콘도";
    else if (word.cat3 === "B02010700") word.type = "펜션";
    else if (["B02010800", "B02010900"].indexOf(word.cat3) >= 0) word.type = "모텔";
    else if (word.cat3 === "B02011100") word.type = "게스트하우스";
    else if (word.cat3 === "A05020100") word.type = "한식";
    else if (word.cat3 === "A05020200") word.type = "서양식";
    else if (word.cat3 === "A05020300") word.type = "일식";
    else if (word.cat3 === "A05020400") word.type = "중식";
    else if (word.cat3 === "A05020500") word.type = "아시아식";
    else if (word.cat3 === "A05020600") word.type = "패밀리레스토랑";
    else if (word.cat3 === "A05020700") word.type = "이색음식점";
}
...
function getQuote(data) {
    ...
    if(data.question_one === "레저/레포츠") quote.question_one = "레포츠";
    else quote.question_one = data.question_one;

    if(data.question_one === "문화여행") quote.tour = "문화";
    else quote.tour = quote.question_one;
